  ...
  public static void Show(SerializedProperty list)
  {
    ...
    if (list.isExpanded && list == class1)
    {
      ...
      for (int i = 0; i < list.arraySize; i++)
      {
        ...
        EditorGUILayout.PropertyField(list.GetArrayElementAtIndex(i), new GUIContent(myTarget.items[i].name), false);
    ...
    else if (list.isExpanded && list == class2)
    {
      ...
      for (int i = 0; i < list.arraySize; i++)
      {
        ...
        EditorGUILayout.PropertyField(list.GetArrayElementAtIndex(i), new GUIContent(myTarget.skills[i].name), false);
    ...
    else if (list.isExpanded && list == class3)
    {
      ...
      for (int i = 0; i < list.arraySize; i++)
      {
        ...
        EditorGUILayout.PropertyField(list.GetArrayElementAtIndex(i), new GUIContent(myTarget.characters[i].name), false);
